...
namespace Agora.SampleCode
{
    /// <summary>
    ///   This script shares the device screen using the custom video capture
    ///  mothod. In essense, use external video source and the PushVideoFrame 
    ///  API to push the video byte stream to Agora.
    /// </summary>
